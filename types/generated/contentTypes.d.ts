...
export interface ApiBisAriclteBisAriclte extends Struct.CollectionTypeSchema {
  collectionName: 'bis_aricltes';
  info: {
    displayName: 'BIS Articles';
    pluralName: 'bis-aricltes';
    singularName: 'bis-ariclte';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiBisBannerBisBanner extends Struct.CollectionTypeSchema {
  collectionName: 'bis_banners';
  info: {
    displayName: 'BIS Banners';
    pluralName: 'bis-banners';
    singularName: 'bis-banner';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Desktop: Schema.Attribute.Media<'images' | 'files', true> &
      Schema.Attribute.Required;
...
export interface ApiPagesSeoPagesSeo extends Struct.CollectionTypeSchema {
  collectionName: 'pages_seos';
  info: {
    displayName: 'Pages SEO';
    pluralName: 'pages-seos';
    singularName: 'pages-seo';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiSitesContactSitesContact
  ...
  info: {
    displayName: 'Sites Contacts';
    pluralName: 'sites-contacts';
    singularName: 'sites-contact';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiWebsiteWebsite extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    pages_seos: Schema.Attribute.Relation<
      'oneToMany',
      'api::pages-seo.pages-seo'
    >;
    publishedAt: Schema.Attribute.DateTime;
